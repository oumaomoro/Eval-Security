 ...
 * Advanced e-Signature workflows for CyberOptimize Enterprise
 */
...
export class SignnowService {
  ...
  static async createEmbeddedSession(fileBuffer, filename, signerEmail) {
    try {
      ...
      // SignNow Free/Test API often requires fields to be present. 
      // For this implementation, we assume a "Role" based invite.
