...
import { CheckCircle2, ShieldCheck, Zap, BarChart3, Globe, Lock, Users, ArrowRight, Star, Twitter, Linkedin, Github, MapPin } from "lucide-react";
        ...
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-5 gap-12">
          ...
          <div>
             ...
             <div className="flex items-center gap-4">
                <a href="#" className="w-8 h-8 rounded-full bg-white/5 flex items-center justify-center hover:bg-emerald-500/20 hover:scale-110 text-slate-500 hover:text-emerald-400 transition-all">
                  <Twitter className="w-4 h-4" />
                </a>
                <a href="#" className="w-8 h-8 rounded-full bg-white/5 flex items-center justify-center hover:bg-emerald-500/20 hover:scale-110 text-slate-500 hover:text-emerald-400 transition-all">
                  <Linkedin className="w-4 h-4" />
                </a>
                <a href="https://github.com/oumaomoro/Eval-Security" className="w-8 h-8 rounded-full bg-white/5 flex items-center justify-center hover:bg-emerald-500/20 hover:scale-110 text-slate-500 hover:text-emerald-400 transition-all">
